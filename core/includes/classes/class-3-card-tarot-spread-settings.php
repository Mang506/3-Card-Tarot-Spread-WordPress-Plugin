 ...
 * 
 * 3CARDTAROT->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class 3_Card_Tarot_Spread_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		3CARDTAROT
 * @subpackage	Classes/3_Card_Tarot_Spread_Settings
 * @author		Jaclyn Rubly
 * @since		1.1
 */
class 3_Card_Tarot_Spread_Settings{
	...
	/**
	 * Our 3_Card_Tarot_Spread_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = 3CARDTAROT_NAME;
	}
	...
	public function get_plugin_name(){
		return apply_filters( '3CARDTAROT/settings/get_plugin_name', $this->plugin_name );
	}
}
